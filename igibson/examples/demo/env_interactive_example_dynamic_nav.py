...
def plan_base_motions(env, goal, robot_number = 0):
        ...
        # print("mesh_body_id in the plan based motion function", env.scene.mesh_body_id)
        # print("mp_obstacles in the plan based motion function", env.scene._load())
        # print("mp_obstacles scene load in the plan based motion function", env.robots[robot_number].robot_ids[0])
        # env.base_mp_resolutions = np.array([0.05, 0.05, 0.05])
