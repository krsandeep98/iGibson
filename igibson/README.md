...
- Anaconda
- Also see the minimum system requirements on the [Installation webpage](http://svl.stanford.edu/igibson/docs/installation.html#installing-the-environment) for iGibson.
...
```
- Check if igibson is installed on your machine by running `import igibson` in your conda environment
...
- Make sure to activate your virtual environment (conda or virtualenv, whichever you used to install the libraries and dependencies). It is strongly recommended to use a virtual environment.
