...
class PointReachRandomTask(PointNavFixedTask):
    """
    ...
    def __init__(self, env):
        super(PointReachRandomTask, self).__init__(env)
    ...
    def reset_scene(self, env):
        ...
        super(PointReachRandomTask, self).reset_scene(env)
    ...
    def reset_agent(self, env):
        ...
        super(PointReachRandomTask, self).reset_agent(env)
