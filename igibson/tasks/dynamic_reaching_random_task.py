...
class DynamicReachingRandomTask(ReachingRandomTask):
    """
    ...
    def __init__(self, env):
        super(DynamicReachingRandomTask, self).__init__(env)
    ...
    def reset_dynamic_objects(self, env):
        ...
        for robot in self.dynamic_objects:
            ...
            for _ in range(max_trials):
                ...
                # pos = [-1, -1, 0]#for Aloha, Ackermanville
    ...
    def reset_scene(self, env):
        ...
        :param env: environment instance
        """
        super(DynamicReachingRandomTask, self).reset_scene(env)
    ...
    def step(self, env):
        ...
        :param env: environment instance
        """
        super(DynamicReachingRandomTask, self).step(env)
